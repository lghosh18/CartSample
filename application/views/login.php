...
<html lang="en">
  ...
  <input type="hidden" id="base_path" value="<?php echo base_url(); ?>"/>
					...
					<div class="card p-4 col-md-6">
						...
						<div class="card-body">
							...
							<form novalidate name="loginForm" >
								...
								<div class="row">
								<div class="col-6">
								<button ng-disabled="loginForm.$invalid" data-loading-text="Loging ..." ng-hide="tempUser.id" type="submit" class="btn btn-primary px-4" data-ng-click="login()">Login</button>
								</div>
    ...
    <script src="<?php echo base_url(); ?>app/controllers/LoginController.js?x=100"></script>
  </body>
</html>